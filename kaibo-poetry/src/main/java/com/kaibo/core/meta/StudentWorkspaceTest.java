...
public class StudentWorkspaceTest extends WorkspaceCreationBase {
	@Override
	@Before
	public void setup() {
		// 在子类中重定义
		urlList = "/kaibo/student/list";
		urlForm = "/kaibo/student/form";
	...
	protected PDatagrid createDatagrid(ResourceNode node) {
		...
		addColumn(datagrid, "student.fullName", "班级", ControlTypes.TEXT_BOX, 100, true);
	...
	protected PForm createForm(ResourceNode node) {
		...
		addFormField(form, "gradeClass.fullName", "班级", ControlTypes.REFERENCE_BOX, false, true);
