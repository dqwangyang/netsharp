...
import org.netsharp.wx.sdk.tp.bean.response.component.wxa.JsCode2sessionResponse;
...
public class LoginApi {
    static Log log = LogFactory.getLog(LoginApi.class);
    ...
    public static JsCode2sessionResponse jscode2session(String componentAccessToken, String appId,
        ...
        log.info("====================== jscode2session params : " + params);
