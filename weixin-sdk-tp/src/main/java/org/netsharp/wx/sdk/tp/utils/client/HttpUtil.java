...
import org.netsharp.wx.sdk.tp.utils.client.httpclient.HttpClientDelegate;
...
public class HttpUtil {
    ...
    public static MediaFile download(String url, Map<String, String> params,String postData) {
        return delegate.download(url, params,postData);
    }
