...
public class NWeixinResponsorWorkspaceTest extends WorkspaceCreationBase {

	@Override
	@Before
	public void setup() {

		urlList = "/wx/responsor/list";
		urlForm = "/wx/responsor/form";
		entity = NWeixinResponsor.class;
		meta = MtableManager.getMtable(entity);
		formPartName = listPartName = meta.getName();
		resourceNodeCode = NWeixinResponsor.class.getSimpleName();
	}
